"""
Django settings for ServerChecker project.
...
SECRET_KEY = '%7ju$kn&+t^83hp%%!ul=$=2&do#pv81c0$=fpi9ok@y1%#u=k'
...
ROOT_URLCONF = 'ServerChecker.urls'
...
WSGI_APPLICATION = 'ServerChecker.wsgi.application'
